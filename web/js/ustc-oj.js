...
app.service('problemService', function() {
...
app.service('userService', function($rootScope, $cookies, $http) {
    ...
    login = function (username, password) {
        ...
        return $http.post($rootScope.apiHost + $rootScope.loginUrl, data, config)
    ...
    register = function (username, password) {
        ...
        $http.post($rootScope.apiHost + $rootScope.registerUrl, data, config)
            .then(function (response) {
                alert(response);
            });
