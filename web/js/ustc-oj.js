...
app.service('networkService', function($http, userService) {
...
app.service('problemService', function(userService) {



});

app.service('userService', function($rootScope, $cookies, $http, networkService) {
